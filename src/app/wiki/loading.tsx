export default function WikiLoading() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      <div className="mb-6">
        <div className="h-8 w-28 animate-pulse rounded bg-foreground/10" />
      </div>

      {/* Toolbar placeholder */}
      <div className="mb-6 flex items-center gap-3">
        <div className="h-10 flex-1 animate-pulse rounded-md bg-foreground/10" />
        <div className="h-10 w-32 animate-pulse rounded-md bg-foreground/10" />
      </div>

      {/* Page card placeholders */}
